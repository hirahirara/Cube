const camera =
{
    ...
    allCamera: function ()
    {
        ...
        if(this.width*mainCan.height < this.height*mainCan.width)
        {
            this.width = this.height*mainCan.width/mainCan.height;
        }
        else if(this.width*mainCan.height > this.height*mainCan.width)
        {
            this.height = this.width*mainCan.height/mainCan.width;
        }
    },
